...
class Admin extends CI_Controller
{
    ...
    public function prestasi_akademik()
    {
        ...
        $this->db->where('pres_ak', 1);
        $this->db->order_by('id', 'DESC');
        $data['data_prestasi'] =  $this->db->get('siswa')->result_array();
        ...
        $this->db->order_by('id', 'DESC');
        $data['prestasi'] =  $this->db->get('pres_akademik')->result_array();
    ...
    public function prestasi_non_akademik()
    {
        ...
        $this->db->order_by('id', 'DESC');
        $data['prestasi'] =  $this->db->get('pres_non_akademik')->result_array();
