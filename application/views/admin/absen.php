                ...
                <form action="<?= base_url('update/update_status_absen/admin') ?>" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="absen<?= $d['id'] ?>" name="absen" onchange="getval(this);">
                        ...
                        <div id="izins<?= $d['id'] ?>" class="form-group">
                            <label>Perizinan</label>
                            <select class="form-control" id="izin<?= $d['id'] ?>" name="izin">
