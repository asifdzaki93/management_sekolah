...
<div class="modal fade" id="addNewData" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/data_prestasi_akademik') ?>" method="post">
                        ...
                        <table class="table table-hover" id="mytable">
                            ...
                            <tbody>
                                ...
                                foreach ($data_prestasi as $d) : ?>
                                    <?php $tot = $this->db->get_where('pres_akademik', ['id_siswa' => $d['id']])->num_rows(); ?>
...
<?php foreach ($data_prestasi as $d) : ?>
    <?php $pres = $this->db->get_where('pres_akademik', ['id_siswa' => $d['id']])->result_array(); ?>
    <?php $kam = $this->db->get_where('data_kelas', ['id' => $d['id_kelas']])->row_array(); ?>
    <?php $rib = $this->db->get_where('data_pendidikan', ['id' => $d['id_pend']])->row_array(); ?>
    <!--update Data-->
    ...
    <div class="modal fade" id="addNewDataPres<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/prestasi_akademik') ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('hapus/data_prestasi_akademik/admin?id=' . $d['id']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                </div>
    ...
    <div class="modal fade" id="updateData<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('update/prestasi_akademik') ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="deleteData<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                    <a href="<?= base_url('hapus/prestasi_akademik/admin?id=' . $d['id']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                </div>
