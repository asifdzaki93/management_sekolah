                    ...
                    <div style="width:100%; overflow-x:scroll">
                        <table class="table table-hover" id="mytable">
                            ...
                            foreach ($karyawan as $d) :
                                $sekolah = $this->db->get_where('data_pendidikan', ['id' => $d['id_pend']])->row_array();
                                $divisi = $this->db->get_where('data_divisi', ['id' => $d['id_divisi']])->row_array();
                                $sum_hadir = $this->db->get_where('absen_pegawai', ['status' => '1', 'id_peng' => $d['id']])->num_rows();
                                ?>
                                <tr>
                                    <th scope="row"><?= $i ?></th>
                                    <td><?= $d['nama']; ?></td>
                                    <td><?= $sekolah !== null ? $sekolah['nama'] : '' ?></td>
                                    <td><?= $divisi !== null ? $divisi['nama'] : '' ?></td>
                                    <td><?= $sum_hadir ?></td>
