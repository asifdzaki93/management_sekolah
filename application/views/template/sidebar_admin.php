...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <?php if ($menu == 'ppdb') : ?>
        ...
        <?php if ($menu == 'prestasi') : ?>
            ...
            <li class="nav-item">
            <?php endif; ?>
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwoAK" aria-expanded="true" aria-controls="collapseTwo">
                <i class="fas fa-fw fa-star"></i>
                <span>Prestasi</span>
            </a>
            <div id="collapseTwoAK" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Pilih menu:</h6>
                    <a class="collapse-item" href="<?= base_url('admin/prestasi_akademik'); ?>">Akademik</a>
                    <a class="collapse-item" href="<?= base_url('admin/prestasi_non_akademik'); ?>">Non Akademik</a>
                </div>
            </div>
            </li>
