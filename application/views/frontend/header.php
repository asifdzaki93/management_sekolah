    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <?php if (!isset($this->session->userdata['nis'])) : ?>
          <li><a class="getstarted scrollto" href="<?= base_url('auth'); ?>">Login</a></li>
          <?php else : ?>
          <li><a class="getstarted scrollto" style="background-color: #dc3545;border-color: #dc3545;" href="<?= base_url('ppdb/logout') ?>">Logout</a></li>
          <?php endif ?>
        </ul>
